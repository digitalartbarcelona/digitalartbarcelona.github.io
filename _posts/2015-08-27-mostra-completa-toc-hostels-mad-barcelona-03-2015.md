---
layout: post
title: "Mostra Completa TOC Hostels MAD Barcelona 2015 (III)"
category: videos
share: true
class: videos
og: true
...
<figure class="no-margin margin-bottom-1">
    ...
    <figcaption>
      <p><small><strong>{{ video.title }}</strong>. Mostra Completa a / Muestra complete en / Full show at: <span class="label label-info"><a href="/place/2015/06/05/toc/">TOC Hostels</a></span></small></p>
    </figcaption>
</figure>
